...
define void @__ctor_C(ptr %this, i32 %v) {
entry:
  ...
  %field.ptr = getelementptr %C, ptr %1, i32 0, i32 0
  store i32 %0, ptr %field.ptr, align 4
  ret void
}

define i32 @C.get(ptr %this) {
entry:
  %this1 = alloca ptr, align 8
  store ptr %this, ptr %this1, align 8
  %0 = load ptr, ptr %this1, align 8
  %field.ptr = getelementptr %C, ptr %0, i32 0, i32 0
...
entry:
  ...
  %obj = call ptr @GC_malloc(i64 ptrtoint (ptr getelementptr (%C, ptr null, i32 1) to i64))
  call void @__ctor_C(ptr %obj, i32 42)
  store ptr %obj, ptr %c, align 8
  %0 = load ptr, ptr %c, align 8
  %1 = call i32 @C.get(ptr %0)
  ret i32 %1
}
