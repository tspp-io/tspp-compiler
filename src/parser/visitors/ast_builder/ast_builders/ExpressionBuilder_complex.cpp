...
Shared(ast::Expr) ExpressionBuilder::buildBinary(tokens::TokenStream& stream, int minPrec) {
    return nullptr;
}

Shared(ast::CallExpr) ExpressionBuilder::buildCall(tokens::TokenStream& stream, Shared(ast::Expr) callee) {
    return nullptr;
}
